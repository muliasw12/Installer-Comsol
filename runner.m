...
close all
load csca_Aggregate_Si_elongasi_linear_20_Ey_kx % csca from SIE
...
title('csca aggregate elongasi 15, r = 30 nm - Ey kx')
legend('c_{sca} decomp','c_{sca} SIE','E_1','M_1','E_2','M_2','E_3')
ylim([0 2*10^(-13)])
